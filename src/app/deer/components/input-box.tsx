...
export function InputBox({
  ...
  return (
    <div className={cn("bg-card relative rounded-lg border border-gray-200 dark:border-gray-700", className)}>
      <div className="w-full">
        ...
        <textarea
          ref={textareaRef}
          className={cn(
            "m-0 w-full resize-none border-none px-3 py-2 text-base",
